...
阶段到手册文档的映射(按轨道重排;本次修订后**手册 7 份 + 1 份入口页**,原 11 份按轨道合并):
...
| L1 + L2 | W(D 轨道也要) | [docs/02-windows.md](../02-windows.md)(Windows 全新安装与激活)+ L2 预检与基线闸门卡(原 `03-preflight.md` 并入;两者都在 Windows 侧、且必须在同一会话内连续完成) |
