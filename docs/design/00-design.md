...
| L1 + L2 | W(D 轨道也要) | [docs/02-windows.md](../02-windows.md)(Windows 全新安装与激活)+ L2 预检与基线闸门卡(原 `03-preflight.md` 并入;两者都在 Windows 侧、且必须在同一会话内连续完成)。**实施时本文档改名为 `03-windows.md`**:分盘抽为独立前置章节后,轨道 W 的卡整体改号为 03-K |
